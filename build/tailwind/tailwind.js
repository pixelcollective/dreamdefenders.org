...
module.exports = tw({
  purge: [
    join(__dirname, './../../web/app/themes/sage/resources/**/*.php'),
    join(__dirname, './../../web/app/themes/sage/resources/**/*.css'),
    join(__dirname, './../../web/app/themes/sage/resources/**/*.js'),
    join(__dirname, './../../web/app/plugins/dream-defenders-blocks/resources/**/*.php'),
    join(__dirname, './../../web/app/plugins/dream-defenders-blocks/resources/**/*.js'),
    join(__dirname, './../../web/app/plugins/dream-defenders-blocks/resources/**/*.css'),
  ],
  prefix: '',
  important: false,
  separator: ':',
