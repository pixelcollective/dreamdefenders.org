<div class="bg-black">
  <div class="container mx-auto">
    <div class="flex flex-col justify-around lg:flex-row">
      <div class="flex-1 hidden w-full overflow-hidden text-white lg:inline-block lg:w-1/5">
  ...
  <div class="relative flex flex-col justify-around h-64 lg:flex-row">
    ...
    <div class="absolute w-8 text-center text-white border border-white" style="top: 25%; left: 50%; right: 50%;">
      Or
    </div>
  </div>
</div>
