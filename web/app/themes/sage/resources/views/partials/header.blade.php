<div class="bg-black w-screen h-full relative">
  <img src="@asset('images/homescreen-bg.png')" class="fixed object-cover h-overflow object-center z--100">
  <div class="bg-gray-600 w-full relative">
