<div class="bg-gradient-b-white-yellow pt-8 md:pt-16 pb-32 relative">
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap flex-col md:flex-row overflow-hidden content-center">
      ...
      <div class="w-full md:w-1/2 overflow-hidden flex flex-col md:align-end px-2 text-left md:text-right align-middle self-center content-center">
        <a href="#" class="font-display uppercase font-bold text-2xl block md:inline w-full md:w-auto relative">
  ...
  <img src="@asset('images/world-we-are-fighting-for.png')" class="freedom-papers-two-col__world-we-are-fighting-for absolute right-0 top-0 hidden" />
</div>
...
@style
  ...
  @media screen and (min-width: 1070px) {
    .freedom-papers-two-col__world-we-are-fighting-for {
      right: 2rem;
      top: 25%;
      height: 300px;
      display: block;
