...
<div class="pt-8 pb-16 bg-center bg-no-repeat bg-cover md:bg-fixed cover" style="background-image: url(@asset('images/background-dark-noisey.png');">
  <div class="container py-4 mx-auto">
    <h1 class="italic font-bold text-center text-white">
      We have nothing to lose but our chains:
    </h1>
  </div>
  <div class="w-full mx-auto bg-white md:w-2/5">
    <div class="w-full bg-gradient-b-yellow-white-blue h-128"></div>
  </div>
</div>
