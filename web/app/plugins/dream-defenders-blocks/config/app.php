...
return [
   ...
   */
   ...
   'blocks' => [
        \DreamDefenders\Blocks\Banner::class,
        \DreamDefenders\Blocks\Container::class,
        \DreamDefenders\Blocks\EveryAction::class,
        \DreamDefenders\Blocks\Form::class,
        \DreamDefenders\Blocks\FreedomPaper::class,
        \DreamDefenders\Blocks\GalleryCTA::class,
        \DreamDefenders\Blocks\HorizontalCard::class,
        \DreamDefenders\Blocks\OrganizeCTA::class,
        \DreamDefenders\Blocks\PostContainer::class,
        \DreamDefenders\Blocks\ProjectContainer::class,
        \DreamDefenders\Blocks\Squadd::class,
        \DreamDefenders\Blocks\TwoColumn::class,
   ],
