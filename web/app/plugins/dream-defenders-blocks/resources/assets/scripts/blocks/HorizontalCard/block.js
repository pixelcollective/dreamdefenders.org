...
const BlockTypeIcon = ({ fill, width, height }) => (
  ...
  >
    <g fillColor={fill ? fill : `rgba(0, 0, 0, 0.6)`}>
      <path
        fill={fill ? fill : `rgba(0, 0, 0, 0.6)`}
        d="M53,25H11c-1.105,0-2-0.895-2-2V3c0-1.105,0.895-2,2-2h42c1.105,0,2,0.895,2,2v20C55,24.105,54.105,25,53,25 z"
      />
      <path
        fill={fill ? fill : `rgba(0, 0, 0, 0.6)`}
        d="M53,63H11c-1.105,0-2-0.895-2-2V41c0-1.105,0.895-2,2-2h42c1.105,0,2,0.895,2,2v20 C55,62.105,54.105,63,53,63z"
      />
