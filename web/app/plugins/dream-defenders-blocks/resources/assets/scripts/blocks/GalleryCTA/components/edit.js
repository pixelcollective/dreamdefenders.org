...
const TW_CLASSES_CTA_TEXT = 'p-2 mt-0 mb-0 font-display uppercase text-xl italic font-bold text-center leading-none mb-0';
const TW_CLASSES_HEADING = 'text-5xl font-bold text-left text-white uppercase leading-none align-bottom leading-none';
...
const edit = ({ attributes, setAttributes, className, isSelected }) => {
  ...
  return (
    <div className={`${className} alignwide`}>
      <div className={`container mx-auto bg-black my-16 px-4 p-16 flex align-bottom flex-col`}>
        ...
        <div className={`flex flex-row flex-wrap flex-auto flex-grow`}>
          <ImageUpload item="one"   onMedia={onMedia} isSelected={isSelected} { ...attributes } />
          <ImageUpload item="two"   onMedia={onMedia} isSelected={isSelected} { ...attributes } />
          <ImageUpload item="three" onMedia={onMedia} isSelected={isSelected} { ...attributes } />
          <ImageUpload item="four"  onMedia={onMedia} isSelected={isSelected} { ...attributes } />
          <ImageUpload item="five"  onMedia={onMedia} isSelected={isSelected} { ...attributes } />
