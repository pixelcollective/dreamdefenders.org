...
var navigation_1 = __webpack_require__(5);
...
Object.defineProperty(exports, "__esModule", { value: true });
var blog_index_1 = __webpack_require__(4);
...
function navigation() {
    ...
    var navMenu = jQuery('#navigation ul');
    var headerHeight = jQuery('header').outerHeight(); // px
    var menuItem = jQuery('.menu-item-has-children').children('a, .sub-menu');
    var menuRow = jQuery('.menu-item-has-children');
    var lastScrollTop = 0; // px
    var triggerPoint = 0; // px
    var didScroll;
    hamburger.click(function () {
        var navIsDown = jQuery('header').hasClass('nav-down');
        var hamburgerOpen = jQuery('.hamburger').hasClass('is-active');
